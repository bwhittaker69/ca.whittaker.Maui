// Platforms/MacCatalyst/UiDatePickerHandler.MacCatalyst.cs
...
namespace ca.whittaker.Maui.Controls
{
    public partial class UiDatePickerHandler : DatePickerHandler
    {
        ...
        {
            if (handler.PlatformView is UIDatePicker native && view != null)
        ...
        {
            if (handler.PlatformView is UIDatePicker native && view != null && view.BorderColor != null)
        ...
        {
            if (handler.PlatformView is UIDatePicker native && view != null && view.TextColor != null)
                native.SetValueForKey(view.TextColor.AsUIColor(), new NSString("textColor"));
        }
