...
namespace ca.whittaker.Maui.Controls
{
    ...
    public enum ImageResourceEnum { Replace2, Signin, Signout, Save, Edit, Cancel, Facebook, Linkedin, Google, Tiktok, Microsoft, Apple, Undo, Camera, Zoom_In, Zoom_Out, Refresh, Media_Stop, Media_Play_Green, Media_Play, Media_Pause, Bullet_Ball_Red }
